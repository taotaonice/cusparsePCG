...
public:
    ...
    MxArray clone()
    {
        return MxArray(mxDuplicateArray(p_));
    }
    ...
    void destroy()
    {
        mxDestroyArray(const_cast<mxArray*>(p_));
    }
     ...
     */
    inline cv::Point toPoint() const
    {
        return toPoint_<int>();
    }
    /** Alias to toPoint_<float>.
     */
    inline cv::Point2f toPoint2f() const
    {
        return toPoint_<float>();
    }
    /** Alias to toPoint3_<float>.
     */
    inline cv::Point3f toPoint3f() const
    {
        return toPoint3_<float>();
    }
    /** Alias to toSize_<int>.
     */
    inline cv::Size toSize() const
    {
        return toSize_<int>();
    }
    /** Alias to toRect_<int>.
     */
    inline cv::Rect toRect() const
    {
        return toRect_<int>();
    }
    /** Alias to toScalar_<double>
     */
    inline cv::Scalar toScalar() const
    {
    ...
    /** Class ID of mxArray.
     */
    inline mxClassID classID() const
    {
     ...
     */
    inline mwSize numel() const
    {
        return mxGetNumberOfElements(p_);
    }
    /** Number of dimensions.
     */
    inline mwSize ndims() const
    {
        return mxGetNumberOfDimensions(p_);
    }
    /** Array of each dimension.
     */
    inline const mwSize* dims() const
    {
        return mxGetDimensions(p_);
    };
    /** Number of rows in an array.
     */
    inline mwSize rows() const
    {
        return mxGetM(p_);
    }
    /** Number of columns in an array.
     */
    inline mwSize cols() const
    {
        return mxGetN(p_);
    }
     ...
     */
    inline bool isFromGlobalWS() const
    {
        return mxIsFromGlobalWS(p_);
    };
     ...
     */
    inline bool isLogicalScalar() const
    {
        return mxIsLogicalScalar(p_);
    }
...
void MxArray::set(mwIndex index, const T& value)
{
    ...
    case mxLOGICAL_CLASS:
        *(mxGetLogicals(p_)+index) = static_cast<mxLogical>(value);
        break;
    case mxCELL_CLASS:
        mxSetCell(const_cast<mxArray*>(p_), index, MxArray(value));
        break;
    case mxSTRUCT_CLASS:
    case mxFUNCTION_CLASS:
    default:
